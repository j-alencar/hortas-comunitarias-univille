...
SET @associacao1 = (SELECT a.uuid FROM associacoes a WHERE a.nome_fantasia = 'Hortas SP' LIMIT 1);
SET @associacao2 = (SELECT a.uuid FROM associacoes a WHERE a.nome_fantasia = 'Hortas RJ' LIMIT 1);
...
SET @usuarioResponsavel1 = (SELECT u.uuid FROM usuarios u WHERE u.email = 'admin_assoc_2@example.com' LIMIT 1);
SET @usuarioResponsavel2 = (SELECT u.uuid FROM usuarios u WHERE u.email = 'admin_assoc_1@example.com' LIMIT 1);
